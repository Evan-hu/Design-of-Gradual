  ...
  <body>
    <div class="container">
      ...
      <div class="passwd">
          ...
          <input type="password" id="checkpasswd" class="form-control" placeholder="Enter password 6 to 12 chars" name="userpasswd" >
      	  <span id="msg-passwd" style="color: red"></span>
      </div>
      <div class="checkCode">
      ...
      <div class="btn-place">
         <button type="submit" class="btn btn-default" onclick="checkAll()">提&nbsp&nbsp交</button>
      </div>
